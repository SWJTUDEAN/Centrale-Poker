...
function ajax (oParams) {
	...
	*/
	//la fonction ajax prend en paramètre un objet de configuration qui configurera la requête dans lequelle se trouve des données (.data), une url, un type, un callback. 
...
function envoiRequete(type,url,donnees,callback)
{
	...
	//la fonction traiteReponse appelle la fonction de rappel en lui fournissant la réponse
